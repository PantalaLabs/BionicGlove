...
4. tight the velcros;
5. adjust so that the notches joining got exactly perpendicular to the glove support plate at the fingers middle position. The position of the main plate is very important for the correct functioning of the glove. Adjust it forwards or backwards until the fingers and the joints have free movement.
